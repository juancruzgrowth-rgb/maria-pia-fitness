...
import { RENEWAL, TRANSFER } from "@/lib/products";
      ...
      <div className="container-page">
        ...
        <RevealOnScroll delay={120}>
          <p className="mt-6 text-sm leading-relaxed text-mp-carbon/70">
            El pago es por transferencia y el acceso te lo doy yo, en{" "}
            {TRANSFER.responseWindow}. No hay débito automático ni tarjeta
            guardada: cuando se acerca el vencimiento de tus{" "}
            {RENEWAL.accessDays} días te escribo, y seguís sólo si querés. No
            hay fechas de inicio ni lista de espera: el día 1 es el día que
            entrás.
          </p>
        </RevealOnScroll>
      </div>
